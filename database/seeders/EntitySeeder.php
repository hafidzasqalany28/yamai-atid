    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'quantity' => 75,
                'image_name' => 'kamboja_pengantin.jpg',
                'image_path' => 'assets/img/',
                'created_at' => now(),
                'updated_at' => now(),
            ],
